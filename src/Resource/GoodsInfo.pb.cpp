...
void protobuf_AssignDesc_GoodsInfo_2eproto() GOOGLE_ATTRIBUTE_COLD;
...
void protobuf_AddDesc_GoodsInfo_2eproto() GOOGLE_ATTRIBUTE_COLD;
void protobuf_AddDesc_GoodsInfo_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "2\020.X.Res.GoodsInfob\006proto3", 946);
...
#define ZR_HELPER_(f) \
  ...
  __builtin_offsetof(GoodsInfo_Price, f) \
...
#define ZR_HELPER_(f) \
  _Pragma("clang diagnostic push") \
  _Pragma("clang diagnostic ignored \"-Winvalid-offsetof\"") \
  __builtin_offsetof(GoodsInfo_GoodsAttr, f) \
  _Pragma("clang diagnostic pop")
#else
#define ZR_HELPER_(f) reinterpret_cast<char*>(\
...
#define ZR_HELPER_(f) \
  _Pragma("clang diagnostic push") \
  _Pragma("clang diagnostic ignored \"-Winvalid-offsetof\"") \
  __builtin_offsetof(GoodsInfo, f) \
  _Pragma("clang diagnostic pop")
#else
#define ZR_HELPER_(f) reinterpret_cast<char*>(\
...
::google::protobuf::uint8* GoodsInfo::InternalSerializeWithCachedSizesToArray(
  ...
  for (unsigned int i = 0, n = this->price_table_size(); i < n; i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
        27, this->price_table(i), false, target);
  }
  ...
  for (unsigned int i = 0, n = this->goods_attr_size(); i < n; i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
        28, this->goods_attr(i), false, target);
  }
...
const ::X::Res::GoodsInfo_GoodsAttr& GoodsInfo::goods_attr(int index) const {
  // @@protoc_insertion_point(field_get:X.Res.GoodsInfo.goods_attr)
  return goods_attr_.Get(index);
}
::X::Res::GoodsInfo_GoodsAttr* GoodsInfo::mutable_goods_attr(int index) {
  // @@protoc_insertion_point(field_mutable:X.Res.GoodsInfo.goods_attr)
  return goods_attr_.Mutable(index);
}
::X::Res::GoodsInfo_GoodsAttr* GoodsInfo::add_goods_attr() {
